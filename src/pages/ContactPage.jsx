...
const Field = ({ label, type = 'text', placeholder, value, onChange, multiline = false, required = false }) => {
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      ...
      <TechBracket color={focused ? '#FF0040' : 'rgba(10,10,10,0.15)'} size={8} style={{ display: 'block', transition: 'all 0.2s' }}>
        <Tag
          type={type}
          ...
          style={{
            ...
            border: `1px solid ${focused ? 'rgba(255,0,64,0.35)' : 'rgba(10,10,10,0.1)'}`,
            outline: 'none',
...
const InfoTile = ({ label, value }) => (
  <div style={{ borderBottom: '1px solid rgba(10,10,10,0.08)', padding: '20px 0' }}>
    <div style={{ fontFamily: 'JetBrains Mono', fontSize: 10, color: '#FF0040', letterSpacing: '0.12em', marginBottom: 6 }}>{label}</div>
    <div style={{ fontFamily: 'JetBrains Mono', fontSize: 12, color: '#0A0A0A', letterSpacing: '0.04em' }}>{value}</div>
  </div>
)
  ...
  return (
    <>
      ...
      <section ref={heroRef} style={{ background: '#0A0A0A', padding: isMobile ? '120px 24px 80px' : '160px 80px 100px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <p style={{ fontFamily: 'JetBrains Mono', fontSize: 13, lineHeight: 1.9, color: 'rgba(244,244,242,0.4)', maxWidth: 500, margin: 0, letterSpacing: '0.02em', ...fade(200) }}>
      ...
      <section style={{
        ...
        {/* Info column */}
        <div>
          <h2 style={{ fontFamily: 'Space Grotesk', fontWeight: 700, fontSize: 'clamp(22px, 2.5vw, 32px)', color: '#0A0A0A', letterSpacing: '-0.03em', margin: '0 0 12px' }}>
            Get in touch.
          </h2>
          <p style={{ fontFamily: 'JetBrains Mono', fontSize: 11, lineHeight: 1.85, color: '#888884', margin: '0 0 40px', letterSpacing: '0.02em' }}>
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginTop: 8 }}>
                ...
                <span style={{ fontFamily: 'JetBrains Mono', fontSize: 10, color: '#BBBBB8', letterSpacing: '0.08em' }}>
            ...
            <div style={{ padding: '40px 32px', border: '1px solid rgba(255,0,64,0.2)', background: 'rgba(255,0,64,0.03)' }}>
              ...
              <h3 style={{ fontFamily: 'Space Grotesk', fontWeight: 700, fontSize: 26, color: '#0A0A0A', letterSpacing: '-0.03em', margin: '0 0 12px' }}>
                We'll be in touch.
              </h3>
